...
class UserController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['User']))
		{
			...
			$check = User::model()->findByAttributes(array('username'=>$model->attributes['username'], 'email'=>$model->attributes['email']));
			if(isset($check)){
				Yii::app()->user->setFlash('error', "Username or Email has registered");
